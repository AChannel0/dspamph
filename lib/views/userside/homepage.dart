...
//   final Map<String, int> spamMessageCountByDate = {};
//   List<SmsMessage> _messages = [];
//   late MessageClassifier
//       _messageClassifier; // Use MessageClassifier instead of Interpreter
//   String prediction = '';
//   List<SmsMessage> spamMessages = [];
//   List<SmsMessage> _cachedMessages = []; // Data cache for filtered messages
//   DateTime _selectedDate = DateTime.now();
...
//   void initState() {
//     super.initState();
//     _messageClassifier = MessageClassifier(); // Initialize MessageClassifier
//     _loadModel();
//     _initSharedPreferences();
...
//   // Add this method to _HomePageState class
...
//         ],
//       ),
//       body: _showCalendar ? _calendarPage : _buildSpamMessagesView(),
//       drawer: AppDrawer(
//         context,
//         spamMessageCountByDate: spamMessageCountByDate,
//         uploadedSpamData: uploadedSpamData,
...
//         onTap: (index) {
//           if (index == 1) {
//             // Call the new method to navigate to CalendarPage
//             _navigateToCalendarPage();
//           } else if (index == 2) {
//             // Navigate to SpamReportsHistoryPage
//             _navigateToSpamReportsHistoryPage();
//           } else {
//             setState(() {
//               _showCalendar = false;
//             });
...
//   // Function to toggle between calendar and spam view
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _loadModel();
    _initSharedPreferences();
    _initSmsListener(); // Move this line here
